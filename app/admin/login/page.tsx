    ...
    <main className="admin-login-shell">
      <section className="admin-login-card" aria-labelledby="admin-login-title">
        ...
        <form action="/api/admin/login" method="post">
          ...
          <div><LockKeyhole size={18} /><input id="admin-password" name="password" type="password" autoComplete="current-password" required autoFocus /></div>
        ...
        {!configured ? <small>Add ADMIN_PASSWORD and ADMIN_SESSION_SECRET to the server environment.</small> : <small>Session expires after 8 hours.</small>}
      </section>
    </main>
  );
}
